...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        def write_to_csv(image_name, prediction, confidence, kidney_risk):
            data = {'Image Name': image_name, 'Prediction': prediction, 'Confidence': confidence, 'Kidney Risk': kidney_risk}
